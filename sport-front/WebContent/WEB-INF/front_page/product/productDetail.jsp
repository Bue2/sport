...
<div class="w ofc mt">
	<div class="l">
		<div class="showPro">
			<div class="big"><a id="showImg" class="cloud-zoom" href="${pageContext.request.contextPath }/res/img/pic/ppp0.jpg" rel="adjustX:10,adjustY:-1"><img alt="" src="${pageContext.request.contextPath }/res/img/pic/ppp0.jpg"></a></div>
		</div>
	</div>
		...
		<ul class="uls form">
			...
			<li><label>选择颜色：</label>
				<div id="colors" class="pre spec">
					<a onclick="colorToRed(this,9)" href="javascript:void(0)" title="西瓜红" class="changToRed"><img width="25" height="25" data-img="1" src="${pageContext.request.contextPath }/res/img/pic/ppp00.jpg" alt="西瓜红 "><i>西瓜红</i></a>
					<a onclick="colorToRed(this,11)" href="javascript:void(0)" title="墨绿" class="changToWhite"><img width="25" height="25" data-img="1" src="${pageContext.request.contextPath }/res/img/pic/ppp00.jpg" alt="墨绿 "><i>墨绿</i></a>
					<a onclick="colorToRed(this,18)" href="javascript:void(0)" title="浅粉" class="changToWhite"><img width="25" height="25" data-img="1" src="${pageContext.request.contextPath }/res/img/pic/ppp00.jpg" alt="浅粉 "><i>浅粉</i></a>
				</div>
			</li>
...
<div class="r wr">
		...
		<div class="box bg_white ofc">
			<div id="detailTab1" class="detail">
				<img src="${pageContext.request.contextPath }/res/img/pic/p800b.jpg" /><img src="${pageContext.request.contextPath }/res/img/pic/p800a.jpg" /><img src="${pageContext.request.contextPath }/res/img/pic/p800c.jpg" /><img src="${pageContext.request.contextPath }/res/img/pic/p800d.jpg" />
			</div>
