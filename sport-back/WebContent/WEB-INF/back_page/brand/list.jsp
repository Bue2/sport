...
品牌名称: <input type="text" name="name" value="${name }"/>
	<select name="isDisplay">
		...
		<option value="0" <c:if test="${isDisplay == 0}"> selected="selected" </c:if>>不显示</option>
	</select>
...
<table cellspacing="1" cellpadding="0" border="0" width="100%" class="pn-ltable">
	...
	<c:forEach items="${brandsList}" var="brand">
		...
		<tr bgcolor="#ffffff" onmouseout="this.bgColor='#ffffff'" onmouseover="this.bgColor='#eeeeee'">
			...
			<td align="center"><img width="40" height="40" src="${pageContext.request.contextPath }/res/img/pic/ppp.jpg"/></td>
			<td align="center"></td>
...
<div class="page pb15">
	<span class="r inb_a page_b">
		...
		<a href="${pageContext.request.contextPath }/brand/list.do?&amp;isShow=0&amp;pageNo=2">2</a>
	
		<a href="${pageContext.request.contextPath }/brand/list.do?&amp;isShow=0&amp;pageNo=3">3</a>
	
		<a href="${pageContext.request.contextPath }/brand/list.do?&amp;isShow=0&amp;pageNo=4">4</a>
